...
{
    /// <summary>
    /// Replace fonts in the scene with another font.
    /// 
    /// Original by ThomLaurent, see https://answers.unity.com/questions/1196846/how-do-i-change-font-of-all-texts-in-all-scenes.html
    /// </summary>
    public class FontReplacer : EditorWindow
    {
        private const string EditorPrefsKey = "Utilities.FontReplacer";
        private const string MenuItemName = "Tools/Wizards Code/Editor/Replace Fonts...";
